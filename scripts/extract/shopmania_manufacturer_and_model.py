...
sites = [
    ['2013_camera_specs/www.shopmania.in/', ['brand', 'product name']]
]
        ...
        with open(s[0] + filename) as f:
            ...
            if s[1][0] in data:
                ...
                for brand in brands:
                    ...
                    if s[1][1] in data:
                        model = data[s[1][1]][0].upper().replace(brand, '').replace(' ', '')
...
with open('extracted_data/manufacturers-with-models-shopmania.json', 'w') as outfile:
